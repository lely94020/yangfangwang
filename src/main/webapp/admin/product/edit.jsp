...
<div class="main">
    <div class="header"><div class="breadcrumb">编辑商品</div></div>
    <div class="content">
        <div class="form-card">
            ...
            <form action="${pageContext.request.contextPath}/admin/product" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label>通用名</label>
                        <input type="text" name="genericName" value="${product.genericName}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label>批准文号</label>
                        <input type="text" name="approvalNumber" value="${product.approvalNumber}">
                    </div>
                    <div class="form-group">
                        <label>生产厂家</label>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label>剂型</label>
                        <input type="text" name="dosageForm" value="${product.dosageForm}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
